...
const { Mail, Phone, Linkedin, MessageCircle } = lucideReact;
const { ResponsiveContainer, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar, Animate } = Recharts;
...
ReactDOM.render(<BusinessManagementPage />, document.getElementById('root'));
